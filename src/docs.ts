...
import { DocumentedClass, DocumentedMethod, DocumentedInterface, DocumentedTypeDef, DocumentedExternal, DocumentedConstructor, DocumentedEvent, DocumentedMember } from "./docs/index";
...
export class Docs {
    ...
    constructor(data: DeclarationReflection[] | RootTypes[], private config: Config, private custom?: Record<string, CustomDocs>) {
    ...
    parse(items: ChildTypes[] | DeclarationReflection[], prop?: DeclarationReflection) {
